...
public class GolfScoresVersion2 {
	...
	public static void fillArray(PaetiallyFilledArray a)
	{
	...
	public static double computeAverage(PaetiallyFilledArray a)
	{
		double total =0;
	...
	public static void showDifference(PaetiallyFilledArray a)
	{
	...
	public static void main(String[] args) {
		...
		PaetiallyFilledArray score = new PaetiallyFilledArray(MAX_NUMBER_SCORES);
